...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-semibold uppercase tracking-wider transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-secondary hover:-translate-y-0.5 shadow-button hover:shadow-hover",
        destructive:
        ...
        hero: "bg-background text-secondary hover:bg-primary hover:text-primary-foreground hover:-translate-y-0.5 shadow-button",
        white: "bg-background text-secondary border-2 border-background hover:bg-primary hover:text-primary-foreground hover:border-primary hover:-translate-y-0.5",
      },
      size: {
